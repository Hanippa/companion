...
export default function Info() {
  return (
    ...
    <ul className="flex w-full h-full flex-col justify-around">
    <li className="border-b-2 border-b-gray-50">
        <div className="flex justify-end items-center">
        
          <div dir="rtl" className="text-2xl">FIX 42 שירות תיקונים</div>
      ...
      <div className="flex justify-end items-center">
          ...
          <div className="text-2xl flex items-center justify-end">אייפון 15 פרו מקס <img className="w-6 m-4" src={RepairIcon} alt="" /></div>
      ...
      <li className="border-b-2 border-b-gray-50">
        <div className="flex justify-end items-center">
          ...
          <div dir="rtl" className="text-2xl">נעמה ווינשטיין </div>
          <img className="w-6 m-4" src={PersonIcon} alt="" />
        </div>
      </li>
      <li className="border-b-2 border-b-gray-50">
        <div className="flex justify-end items-center">
          <div className="text-2xl">15/01/2026 - 9:15</div>
      ...
      <li className="border-b-2 border-b-gray-50">
        <div className="flex justify-end items-center">
          <div className="flex flex-col items-end">
          <div dir="rtl" className="text-2xl">מרכז שירות דיזנגוף</div>
          ...
          <div dir="rtl" className="text-md text-gray-400">דיזנגוף 52, תל אביב - יפו</div>
